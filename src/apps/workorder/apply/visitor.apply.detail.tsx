...
export namespace VisitorApplyDetail {
    ...
    export class Component<P extends IProps = IProps, S extends IState = IState> extends ViewComponent.Base<P, S> {
        ...
        componentDidMount() {
            setNavTitle.call(this, "我的访客预约工单");

            setEventWithLabel(statisticsEvent.myCheckinDetailView);
            setEventWithLabel(statisticsEvent.myVerificationDetailView);
        ...
        componentReceiveProps(nextProps: Readonly<IProps>): void {
            setNavTitle.call(this, "我的访客预约工单", nextProps);
        }
        ...
        renderFooter() {
            ...
            return (
                ...
                this.renderEmbeddedView(ApprovalStateSubmit.Page, {
                    triggerCodes: this.visitortriggerCodes,
